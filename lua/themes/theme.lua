...
theme.set_highlights = function(opts)
    ...
    hl(0, 'Comment',                                 { fg = colors.grey_400,      bg = colors.grey_900 })
    ...
    -- Treesitter
    hl(0, '@error',                                  { fg = colors.blue,          bg = colors.grey_900 })
    hl(0, '@punctuation.bracket',                    { fg = colors.red,           bg = colors.grey_900 })
    hl(0, '@punctuation.special',                    { fg = colors.blue,          bg = colors.grey_900 })
    hl(0, '@punctuation.delimiter',                  { fg = colors.blue,          bg = colors.grey_900 })
    hl(0, '@comment',                                { fg = colors.grey_500,      bg = colors.grey_900 })
    hl(0, '@comment.note',                           { fg = colors.blue,          bg = colors.grey_900 })
    hl(0, '@comment.warning',                        { fg = colors.blue,          bg = colors.grey_900 })
    hl(0, '@comment.error',                          { fg = colors.blue,          bg = colors.grey_900 })
    hl(0, '@constant',                               { fg = colors.green,         bg = colors.grey_900 })
    hl(0, '@constant.builtin',                       { fg = colors.green,         bg = colors.grey_900 })
    hl(0, '@constant.macro',                         { fg = colors.green,         bg = colors.grey_900 })
    hl(0, '@string.regexp',                          { fg = colors.green,         bg = colors.grey_900 })
    hl(0, '@string',                                 { fg = colors.green,         bg = colors.grey_900 })
    hl(0, '@character',                              { fg = colors.blue,          bg = colors.grey_900 })
    hl(0, '@number',                                 { fg = colors.red,           bg = colors.grey_900 })
    hl(0, '@number.float',                           { fg = colors.red,           bg = colors.grey_900 })
    hl(0, '@boolean',                                { fg = colors.red,           bg = colors.grey_900 })
    hl(0, '@annotation',                             { fg = colors.yellow,        bg = colors.grey_900 })
    hl(0, '@attribute',                              { fg = colors.yellow,        bg = colors.grey_900 })
    hl(0, '@attribute.builtin',                      { fg = colors.yellow,        bg = colors.grey_900 })
    hl(0, '@module',                                 { fg = colors.yellow,        bg = colors.grey_900 })
    hl(0, '@function',                               { fg = colors.yellow,        bg = colors.grey_900 })
    hl(0, '@function.builtin',                       { fg = colors.blue,          bg = colors.grey_900 })
    hl(0, '@function.macro',                         { fg = colors.blue,          bg = colors.grey_900 })
    hl(0, '@function.method',                        { fg = colors.blue,          bg = colors.grey_900 })
    hl(0, '@define',                                 { fg = colors.blue,          bg = colors.grey_900 })
    hl(0, '@variable',                               { fg = colors.grey_300,      bg = colors.grey_900 })
    hl(0, '@variable.builtin',                       { fg = colors.grey_300,      bg = colors.grey_900 })
    hl(0, '@variable.parameter',                     { fg = colors.grey_300,      bg = colors.grey_900 })
    hl(0, '@variable.parameter.reference',           { fg = colors.grey_300,      bg = colors.grey_900 })
    hl(0, '@variable.member',                        { fg = colors.grey_300,      bg = colors.grey_900 })
    hl(0, '@property',                               { fg = colors.grey_300,      bg = colors.grey_900 })
    hl(0, '@constructor',                            { fg = colors.blue,          bg = colors.grey_900 })
    hl(0, '@label',                                  { fg = colors.blue,          bg = colors.grey_900 })
    hl(0, '@keyword',                                { fg = colors.purple,        bg = colors.grey_900 })
    hl(0, '@keyword.conditional',                    { fg = colors.purple,        bg = colors.grey_900 })
    hl(0, '@keyword.repeat',                         { fg = colors.purple,        bg = colors.grey_900 })
    hl(0, '@keyword.return',                         { fg = colors.purple,        bg = colors.grey_900 })
    hl(0, '@keyword.exception',                      { fg = colors.purple,        bg = colors.grey_900 })
    hl(0, '@keyword.import',                         { fg = colors.purple,        bg = colors.grey_900 })
    hl(0, '@operator',                               { fg = colors.grey_300,      bg = colors.grey_900 })
    hl(0, '@type',                                   { fg = colors.teal,          bg = colors.grey_900 })
    hl(0, '@type.qualifier',                         { fg = colors.grey_200,      bg = colors.grey_900 })
    hl(0, '@structure',                              { fg = colors.blue,          bg = colors.grey_900 })
    hl(0, '@tag',                                    { fg = colors.blue,          bg = colors.grey_900 })
    hl(0, '@tag.builtin',                            { fg = colors.blue,          bg = colors.grey_900 })
    hl(0, '@tag.delimiter',                          { fg = colors.blue,          bg = colors.grey_900 })
    hl(0, '@tag.attribute',                          { fg = colors.blue,          bg = colors.grey_900 })

    hl(0, '@text',                                   { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, '@markup.strong',                          { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, '@markup.italic',                          { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, '@markup.underline',                       { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, '@markup.strikethrough',                   { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, '@markup.heading',                         { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, '@markup.heading.1.markdown',              { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, '@markup.heading.2.markdown',              { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, '@markup.heading.3.markdown',              { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, '@markup.heading.4.markdown',              { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, '@markup.heading.5.markdown',              { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, '@markup.heading.6.markdown',              { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, '@markup.raw',                             { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, '@markup.raw.markdown',                    { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, '@markup.raw.markdown_inline',             { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, '@markup.link.label',                      { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, '@markup.link.url',                        { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, '@markup.list.checked',                    { link = 'Todo' })
    hl(0, '@markup.list.unchecked',                  { link = 'Todo' })
    hl(0, '@textReference',                          { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, '@stringEscape',                           { fg = colors.grey_400,      bg = colors.grey_900 })
