...
theme.set_highlights = function(opts)
    ...
    hl(0, 'CursorLine',                              { fg = colors.grey_400,     bg = colors.grey_900 })
    ...
    hl(0, 'VertSplit',                               { fg = colors.grey_400,     bg = colors.grey_900 })
    hl(0, 'WinSeparator',                            { fg = colors.grey_400,     bg = colors.grey_900 })
    ...
    hl(0, 'PmenuSel',                                { fg = colors.grey_400,     bg = colors.grey_900 })
    ...
    hl(0, 'Comment',                                 { fg = colors.grey_600,     bg = colors.grey_900 })
    hl(0, 'Constant',                                { fg = colors.grey_400,     bg = colors.grey_900 })
    hl(0, 'String',                                  { fg = colors.grey_400,     bg = colors.grey_900 })
    hl(0, 'Character',                               { fg = colors.grey_400,     bg = colors.grey_900 })
    hl(0, 'Number',                                  { fg = colors.grey_400,     bg = colors.grey_900 })
    hl(0, 'Boolean',                                 { fg = colors.grey_400,     bg = colors.grey_900 })
    hl(0, 'Float',                                   { fg = colors.grey_400,     bg = colors.grey_900 })
    ...
    -- Treesitter
    hl(0, '@error',                                  { fg = colors.purple,       bg = colors.grey_900 })
    hl(0, '@punctuation.bracket',                    { fg = colors.yellow,       bg = colors.grey_900 })
    hl(0, '@punctuation.special',                    { fg = colors.yellow,       bg = colors.grey_900 })
    hl(0, '@punctuation.delimiter',                  { fg = colors.green,        bg = colors.grey_900 })
    hl(0, '@comment',                                { fg = colors.comments,     bg = colors.grey_900 })
    hl(0, '@comment.note',                           { fg = colors.types,        bg = colors.grey_900 })
    hl(0, '@comment.warning',                        { fg = colors.functions,    bg = colors.grey_900 })
    hl(0, '@comment.error',                          { fg = colors.vscRed,       bg = colors.grey_900 })
    hl(0, '@constant',                               { fg = colors.enums,        bg = colors.grey_900 })
    hl(0, '@constant.builtin',                       { fg = colors.keywords,     bg = colors.grey_900 })
    hl(0, '@constant.macro',                         { fg = colors.types,        bg = colors.grey_900 })
    hl(0, '@string.regexp',                          { fg = colors.strings,      bg = colors.grey_900 })
    hl(0, '@string',                                 { fg = colors.strings,      bg = colors.grey_900 })
    hl(0, '@character',                              { fg = colors.strings,      bg = colors.grey_900 })
    hl(0, '@number',                                 { fg = colors.numbers,      bg = colors.grey_900 })
    hl(0, '@number.float',                           { fg = colors.numbers,      bg = colors.grey_900 })
    hl(0, '@boolean',                                { fg = colors.keywords,     bg = colors.grey_900 })
    hl(0, '@annotation',                             { fg = colors.functions,    bg = colors.grey_900 })
    hl(0, '@attribute',                              { fg = colors.functions,    bg = colors.grey_900 })
    hl(0, '@attribute.builtin',                      { fg = colors.types,        bg = colors.grey_900 })
    hl(0, '@module',                                 { fg = colors.types,        bg = colors.grey_900 })
    hl(0, '@function',                               { fg = colors.functions,    bg = colors.grey_900 })
    hl(0, '@function.builtin',                       { fg = colors.functions,    bg = colors.grey_900 })
    hl(0, '@function.macro',                         { fg = colors.functions,    bg = colors.grey_900 })
    hl(0, '@function.method',                        { fg = colors.functions,    bg = colors.grey_900 })
    hl(0, '@define',                                 { fg = colors.keywords,     bg = colors.grey_900 })
    hl(0, '@variable',                               { fg = colors.variables,    bg = colors.grey_900 })
    hl(0, '@variable.builtin',                       { fg = colors.keywords,     bg = colors.grey_900 })
    hl(0, '@variable.parameter',                     { fg = colors.variables,    bg = colors.grey_900 })
    hl(0, '@variable.parameter.reference',           { fg = colors.variables,    bg = colors.grey_900 })
    hl(0, '@variable.member',                        { fg = colors.variables,    bg = colors.grey_900 })
    hl(0, '@property',                               { fg = colors.variables,    bg = colors.grey_900 })
    hl(0, '@constructor',                            { fg = colors.keywords,     bg = colors.grey_900 })
    hl(0, '@label',                                  { fg = colors.variables,    bg = colors.grey_900 })
    hl(0, '@keyword',                                { fg = colors.keywords,     bg = colors.grey_900 })
    hl(0, '@keyword.conditional',                    { fg = colors.keywords,     bg = colors.grey_900 })
    hl(0, '@keyword.repeat',                         { fg = colors.keywords,     bg = colors.grey_900 })
    hl(0, '@keyword.return',                         { fg = colors.keywords,     bg = colors.grey_900 })
    hl(0, '@keyword.exception',                      { fg = colors.keywords,     bg = colors.grey_900 })
    hl(0, '@keyword.import',                         { fg = colors.keywords,     bg = colors.grey_900 })
    hl(0, '@operator',                               { fg = colors.comments,     bg = colors.grey_900 })
    hl(0, '@type',                                   { fg = colors.types,        bg = colors.grey_900 })
    hl(0, '@type.qualifier',                         { fg = colors.keywords,     bg = colors.grey_900 })
    hl(0, '@structure',                              { fg = colors.variables,    bg = colors.grey_900 })
    hl(0, '@tag',                                    { fg = colors.keywords,     bg = colors.grey_900 })
    hl(0, '@tag.builtin',                            { fg = colors.keywords,     bg = colors.grey_900 })
    hl(0, '@tag.delimiter',                          { fg = colors.vscGray,      bg = colors.grey_900 })
    hl(0, '@tag.attribute',                          { fg = colors.variables,    bg = colors.grey_900 })
    hl(0, '@text',                                   { fg = colors.comments,     bg = colors.grey_900 })
    hl(0, '@markup.strong',                          { fg = colors.keywords,     bg = colors.grey_900 })
    hl(0, '@markup.italic',                          { fg = colors.comments,     bg = colors.grey_900 })
    hl(0, '@markup.underline',                       { fg = colors.functions,    bg = colors.grey_900 })
    hl(0, '@markup.strikethrough',                   { fg = colors.comments,     bg = colors.grey_900 })
    hl(0, '@markup.heading',                         { fg = colors.keywords,     bg = colors.grey_900 })
    hl(0, '@markup.heading.1.markdown',              { fg = colors.keywords,     bg = colors.grey_900 })
    hl(0, '@markup.heading.2.markdown',              { fg = colors.strings,      bg = colors.grey_900 })
    hl(0, '@markup.heading.3.markdown',              { fg = colors.functions,    bg = colors.grey_900 })
    hl(0, '@markup.heading.4.markdown',              { fg = colors.vscGreen,     bg = colors.grey_900 })
    hl(0, '@markup.heading.5.markdown',              { fg = colors.keywords,     bg = colors.grey_900 })
    hl(0, '@markup.heading.6.markdown',              { fg = colors.keywords,     bg = colors.grey_900 })
    hl(0, '@markup.raw',                             { fg = colors.comments,     bg = colors.grey_900 })
    hl(0, '@markup.raw.markdown',                    { fg = colors.strings,      bg = colors.grey_900 })
    hl(0, '@markup.raw.markdown_inline',             { fg = colors.strings,      bg = colors.grey_900 })
    hl(0, '@markup.link.label',                      { fg = colors.variables,    bg = colors.grey_900 })
    hl(0, '@markup.link.url',                        { fg = colors.comments,     bg = colors.grey_900 })
    hl(0, '@markup.list.checked',                    { link = 'Todo' })
    hl(0, '@markup.list.unchecked',                  { link = 'Todo' })
    hl(0, '@textReference',                          { fg = colors.strings,      bg = colors.grey_900 })
    hl(0, '@stringEscape',                           { fg = colors.strings,      bg = colors.grey_900 })
    ...
    -- CSS
    hl(0, 'cssBraces',                               { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'cssInclude',                              { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'cssTagName',                              { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'cssClassName',                            { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'cssPseudoClass',                          { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'cssPseudoClassId',                        { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'cssPseudoClassLang',                      { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'cssIdentifier',                           { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'cssProp',                                 { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'cssDefinition',                           { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'cssAttr',                                 { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'cssAttrRegion',                           { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'cssColor',                                { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'cssFunction',                             { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'cssFunctionName',                         { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'cssVendor',                               { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'cssValueNumber',                          { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'cssValueLength',                          { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'cssUnitDecorators',                       { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'cssStyle',                                { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'cssImportant',                            { fg = colors.grey_400,      bg = colors.grey_900 })

    -- JavaScript
    hl(0, 'jsVariableDef',                           { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'jsFuncArgs',                              { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'jsFuncBlock',                             { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'jsRegexpString',                          { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'jsThis',                                  { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'jsOperatorKeyword',                       { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'jsDestructuringBlock',                    { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'jsObjectKey',                             { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'jsGlobalObjects',                         { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'jsModuleKeyword',                         { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'jsClassDefinition',                       { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'jsClassKeyword',                          { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'jsExtendsKeyword',                        { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'jsExportDefault',                         { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'jsFuncCall',                              { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'jsObjectValue',                           { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'jsParen',                                 { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'jsObjectProp',                            { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'jsIfElseBlock',                           { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'jsParenIfElse',                           { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'jsSpreadOperator',                        { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'jsSpreadExpression',                      { fg = colors.grey_400,      bg = colors.grey_900 })  

    -- Typescript
    hl(0, '@type.builtin.typescript',                { link = '@type' })
    hl(0, '@type.builtin.tsx',                       { link = '@type' })
    hl(0, 'typescriptLabel',                         { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'typescriptExceptions',                    { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptBraces',                        { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'typescriptEndColons',                     { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptParens',                        { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'typescriptDocTags',                       { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'typescriptDocComment',                    { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptLogicSymbols',                  { fg = colors.grey_400,      bg = colors.grey_900 })      
    hl(0, 'typescriptImport',                        { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'typescriptBOM',                           { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'typescriptVariableDeclaration',           { fg = colors.grey_400,      bg = colors.grey_900 })          
    hl(0, 'typescriptVariable',                      { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptExport',                        { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'typescriptAliasDeclaration',              { fg = colors.grey_400,      bg = colors.grey_900 })          
    hl(0, 'typescriptAliasKeyword',                  { fg = colors.grey_400,      bg = colors.grey_900 })      
    hl(0, 'typescriptClassName',                     { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptAccessibilityModifier',         { fg = colors.grey_400,      bg = colors.grey_900 })              
    hl(0, 'typescriptOperator',                      { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptArrowFunc',                     { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptMethodAccessor',                { fg = colors.grey_400,      bg = colors.grey_900 })      
    hl(0, 'typescriptMember',                        { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'typescriptTypeReference',                 { fg = colors.grey_400,      bg = colors.grey_900 })      
    hl(0, 'typescriptTemplateSB',                    { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptArrowFuncArg',                  { fg = colors.grey_400,      bg = colors.grey_900 })      
    hl(0, 'typescriptParamImpl',                     { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptFuncComma',                     { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptCastKeyword',                   { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptCall',                          { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'typescriptCase',                          { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'typescriptReserved',                      { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptDefault',                       { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'typescriptDecorator',                     { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptPredefinedType',                { fg = colors.grey_400,      bg = colors.grey_900 })      
    hl(0, 'typescriptClassHeritage',                 { fg = colors.grey_400,      bg = colors.grey_900 })      
    hl(0, 'typescriptClassExtends',                  { fg = colors.grey_400,      bg = colors.grey_900 })      
    hl(0, 'typescriptClassKeyword',                  { fg = colors.grey_400,      bg = colors.grey_900 })      
    hl(0, 'typescriptBlock',                         { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'typescriptDOMDocProp',                    { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptTemplateSubstitution',          { fg = colors.grey_400,      bg = colors.grey_900 })              
    hl(0, 'typescriptClassBlock',                    { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptFuncCallArg',                   { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptIndexExpr',                     { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptConditionalParen',              { fg = colors.grey_400,      bg = colors.grey_900 })          
    hl(0, 'typescriptArray',                         { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'typescriptES6SetProp',                    { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptObjectLiteral',                 { fg = colors.grey_400,      bg = colors.grey_900 })      
    hl(0, 'typescriptTypeParameter',                 { fg = colors.grey_400,      bg = colors.grey_900 })      
    hl(0, 'typescriptEnumKeyword',                   { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptEnum',                          { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'typescriptLoopParen',                     { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptParenExp',                      { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptModule',                        { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'typescriptAmbientDeclaration',            { fg = colors.grey_400,      bg = colors.grey_900 })          
    hl(0, 'typescriptFuncTypeArrow',                 { fg = colors.grey_400,      bg = colors.grey_900 })      
    hl(0, 'typescriptInterfaceHeritage',             { fg = colors.grey_400,      bg = colors.grey_900 })          
    hl(0, 'typescriptInterfaceName',                 { fg = colors.grey_400,      bg = colors.grey_900 })      
    hl(0, 'typescriptInterfaceKeyword',              { fg = colors.grey_400,      bg = colors.grey_900 })          
    hl(0, 'typescriptInterfaceExtends',              { fg = colors.grey_400,      bg = colors.grey_900 })          
    hl(0, 'typescriptGlobal',                        { fg = colors.grey_400,      bg = colors.grey_900 })
    hl(0, 'typescriptAsyncFuncKeyword',              { fg = colors.grey_400,      bg = colors.grey_900 })          
    hl(0, 'typescriptFuncKeyword',                   { fg = colors.grey_400,      bg = colors.grey_900 })  
    hl(0, 'typescriptGlobalMethod',                  { fg = colors.grey_400,      bg = colors.grey_900 })      
    hl(0, 'typescriptPromiseMethod',                 { fg = colors.grey_400,      bg = colors.grey_900 })      
    ...
    hl(0, 'NeoTreeDirectoryIcon',                    { fg = colors.grey_400 })
    ...
    hl(0, 'NeoTreeIndentMarker',                     { fg = colors.grey_600,      bg = colors.grey_875 })
    ...
    hl(0, 'NeoTreeVertSplit',                        { fg = colors.grey_400,      bg = colors.grey_875 })
